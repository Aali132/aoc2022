...
aoc :: [String] -> String
aoc f = show (length (nub (moveTail ((0,0),(moveTail ((0,0),(moveTail ((0,0),(moveTail ((0,0),(moveTail ((0,0),(moveTail ((0,0),(moveTail ((0,0),(moveTail ((0,0),(moveTail ((0,0),(moveHead ((0,0),parse f))))))))))))))))))))))
